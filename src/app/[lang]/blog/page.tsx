        ...
        <main className="flex flex-col bg-ab-black">
            ...
            >
                <section className="flex flex-col items-start gap-4 text-ab-black w-full">
                    ...
                    <div className="flex lg:flex-col xl:flex-row sm:flex-col xs:flex-col lg:items-center md:items-center 
                            ...
                            >
                                <div className="flex flex-col gap-2 w-full">
                                    ...
                                    <div className="flex flex-col gap-2 p-6">
                                        ...
                                        <h4 className="text-xl font-semibold">{item.title[lang]}</h4>
