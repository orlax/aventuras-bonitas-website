...
import { SpringCarousel, SpringCarouselImage } from '@/components/images/spring_carousel/springCarousel'
...
export default async function Home({ params: { lang } }: HomeProps) {
  ...
  const firePromoVideo = fireStorageRef(fireAppStorage, '/assets/featured_game/gameplay_video.mp4');
  ...
  return (
    <main className="block">
      <video className='absolute top-0 w-full' autoPlay muted loop id='gameplay_video'>
        <source src={promoVideo} type='video/mp4'/>
      </video>
      <div className='absolute h-screen w-screen backdrop-blur-sm bg-gradient-to-b from-white/10' />
          ...
          <BglessPanel
            leftContent={
              <div className='xl:h-[500px] md:h-72 xs:56 w-full overflow-hidden rounded-lg flex justify-center items-center'>
                <img className='h-auto w-full' src="/about/the_team.jpg" alt="About Us" />
              </div>
            }
